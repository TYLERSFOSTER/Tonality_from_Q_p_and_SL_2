...
\normalfont
	...
	$$
	\vskip -.3cm
	\caption{{\bf Triangle wave $\pmb{f(s)=\big|t(s)\!-\!\tfrac{1}{2}\big|}$ under 3-adic frequency transform $\pmb{f(26\ \!s)}$.} {\color{red} [...]} The $3$-adic presentation the factor $26$ is $26=2+2\!\cdot\!3+2\!\cdot\!3^2$.}
	\end{figure}
