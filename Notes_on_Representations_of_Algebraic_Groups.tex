...
Every element $\left(\begin{smallmatrix} a & b \\ c & d\end{smallmatrix}\right)\in\text{SL}_{2}(\CC)$ admits a factorization
	...
	\left(\!\begin{array}{cc}1 & w \\ 1 & 0\end{array}\!\right)
	$$
for some $u,v,w\in\CC$. To compute $u,v,w$, observe that the matrix product on the right is equal to
	$$
%	\left(\!\begin{array}{cc}1 & 0 \\ u & 1\end{array}\!\right)
%	\left(\!\begin{array}{cc}e^v & we^v \\ e^{-v} & 0\end{array}\!\right)
%	\ =\ 
	\left(\!\begin{array}{cc}e^v & we^v \\ ue^v-e^-v & uwe^v\end{array}\!\right),
	$$
{\color{red} [...confusing myself... need to come back to this...]}
