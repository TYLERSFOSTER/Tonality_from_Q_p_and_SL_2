...
{\color{red} [...]}
	...
	(-34,-29.5)*+{\text{{\smaller\smaller\color{red} $\bullet$}}};
	(-35.5,-30)*+{\text{{\smaller\smaller\color{red} $0$}}};
	(-17,-29.5)*+{\text{{\smaller\smaller\color{red} $\bullet$}}};
	(-17,-31.5)*+{\text{{\smaller\smaller\color{red} $3$}}};
	(-25.5,-29.5)*+{\text{{\smaller\smaller\color{red} $\bullet$}}};
	(-25.5,-31.5)*+{\text{{\smaller\smaller\color{red} $3^2$}}};
	(-30,-29.5)*+{\text{{\smaller\smaller\color{red} $\bullet$}}};
	(-30,-31.5)*+{\text{{\smaller\smaller\color{red} $3^3$}}};
	(34,-29.75)*+{\text{{\smaller\smaller\color{red} $\bullet$}}};
	(49,-30)*+{\text{{\smaller\smaller\color{red} $1+3+3^2+3^3+\cdots$}}};
	(.7,-29.45)*+{\text{{\smaller\smaller\color{red} $\bullet$}}};
	(.7,-31.75)*+{\text{{\smaller\smaller\color{red} $1$}}};
	(17.75,-29.8)*+{\text{{\smaller\smaller\color{red} $\bullet$}}};
	(17.75,-31.95)*+{\text{{\smaller\smaller\color{red} $1+3$}}};
	(17.25,-.8)*+{\text{{\smaller\smaller\color{red} $\bullet$}}};
	(36.25,-.5)*+{\text{{\smaller\smaller\color{red} $1+2\!\cdot\!3+2\!\cdot\!3^2+2\!\cdot\!3^3+\cdots$}}};
	(-16.8,.6)*+{\text{{\smaller\smaller\color{red} $\bullet$}}};
	(-18.5,.75)*+{\text{{\smaller\smaller\color{red} $2$}}};
	(0,29.5)*+{\text{{\smaller\smaller\color{red} $\bullet$}}};
	(17,32)*+{\text{{\smaller\smaller\color{red} $2+2\!\cdot\!3+2\!\cdot\!3^2+2\!\cdot\!3^3+\cdots$}}};
	(26,5.5)*+{
	\begin{tikzpicture}
	...
	(-35,20.5)*+{
	\begin{tikzpicture}
	\draw[blue, thick, ->] (0,0) -- (.5 * 1.73205080757, -.5);
	\draw[blue, thick, ->] (0,0) -- (-.5 * 1.73205080757, -.5);
	\draw[blue, thick, ->] (0,0) -- (0, 1);
	\node[blue] at (-.6 * 1.73205080757, -.6) {\scalebox{.8}{$0$}};
	\node[blue] at (.6 * 1.73205080757, -.6) {\scalebox{.8}{$1$}};
	\node[blue] at (0, 1.3) {\scalebox{.8}{$2$}};
	\end{tikzpicture}
	};
	\end{xy}
	$$
	\vskip -.3cm
	\caption{{\bf The 3-adic unit Berkovich disk.}}
	\end{figure}
\ 
{\color{red} [...]}
\end{subsection}
...
%$a_{-i}\gets a_{-i}+1$ \;
%}
$\varepsilon\gets$ {\bf real number} $r-a_{-i}p^{i}$ \;
...
{\bf return} $a$, $\varepsilon$ \tcp*[r]{Interpreting $a$ as a rational, we have $t=\varepsilon+a$, with $0\le \varepsilon<\tfrac{1}{p^{m}}$.} 
\end{algorithm}
