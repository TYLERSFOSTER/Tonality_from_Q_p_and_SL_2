...
\ \ \ \cong\ \ \ 
\underset{\!\!\!\!\text{dB}\!\!\!\!}{\!\!\underbrace{\RR}\!\!}\!\times\!\underset{\!\!\!\!\text{Hz}\!\!\!\!}{\!\!\underbrace{\ZZ}\!\!}
$$
\end{subsection}
...
\begin{proposal}\label{proposal: local L- and zeta functions}
{\bf Tones as $\bold{GL}_{1}(\QQ_p)$-transforms of local L- and/or local zeta functions.}
\normalfont

{\color{red} [Use \cite[\S\S2.3-5]{GHv1}. The local zeta function $Z_p(s,\Phi,\omega)$ can transform under $\bold{GL}_{1}(\QQ_p)$ in its arguments $\Phi$ and $\omega$, whereas the argument $s\in\CC$ gives (multiple) realization(s) as an audio signal...]}
\end{proposal}
